...
class Verify {
  ...
  verifyIntoDatabase(name, pic_id, callback) {
    const verify = async (n, p) => {
      try {
        const response = await axios.post("https://2465-2804-14d-7289-8628-dc51-5477-7d1-ad2b.ngrok-free.app/verify", {
          name: n,
          pic_id: p,
        });
        if (response.data) {
  ...
  pushIntoDatabase(name, pic_id, callback) {
    Swal.fire({
      ...
      if (result.value) {
        const verify = async (n, p) => {
          try {
            const response = await axios.post("https://2465-2804-14d-7289-8628-dc51-5477-7d1-ad2b.ngrok-free.app/push", {
              name: n,
              pic_id: p,
            });
            if (response.data) {
    ...
    const getID = async (n, p) => {
      try {
        const response = await axios.get(
          `https://2465-2804-14d-7289-8628-dc51-5477-7d1-ad2b.ngrok-free.app/getID?name=${n}&pic_id=${p}`
        );
